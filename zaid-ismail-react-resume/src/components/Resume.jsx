const Resume = () => {
  return (
    ...
    <div className="w-full max-w-7xl mx-auto p-8 flex flex-col md:flex-row gap-16 border border-gray-300 rounded-lg shadow-md">
      ...
      <div className="w-full md:w-1/2 p-6 border border-gray-300">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Intermediate Software Developer</h3>
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Open-Source Contributor</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Operations Engineer</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
            <span>Tau Space</span>
        ...
        <div className="mb-6">
            <h3 className="text-2xl font-semibold text-gray-900">Back End Developer</h3>
            <p className="text-gray-600 flex justify-between italic text-lg">
              <span>Syntax Co.</span>
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Freelance Cyber Security Research</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
            <span>HackerOne</span>
      ...
      <div className="w-full md:w-1/2 p-6 border border-gray-300">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Bachelor of Science in Engineering (Honours), Civil Engineering</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
        ...
        <h2 className="text-3xl font-bold text-indigo-700 mb-4">Certificates</h2>
        
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Elixir and Phoenix: Real World Functional Programming</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
            <span>Udemy</span>
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">SQL and PostgreSQL: The Complete Developer’s Guide</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
            <span>Udemy</span>
            <span className="text-right">Oct 2022</span>
          </p>
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">Machine Learning</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">AWS-DEV-13: Building Modern .NET Applications on AWS</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-semibold text-gray-900">CS50’s Web Programming with Python and JavaScript</h3>
          <p className="text-gray-600 flex justify-between italic text-lg">
        ...
        <div className="mb-6">
            <h3 className="text-2xl font-semibold text-gray-900">CS50’s Introduction to Computer Science</h3>
            <p className="text-gray-600 flex justify-between italic text-lg">
            <span>Harvard Online</span>
